    ...
    signIn = (email, password) => {
        axios.post('/api/users/login', {email, password}).then(res => {
            if (res.data.success) {
                ...
                {this.props.history.push('/community-quizzes');}
    ...
    render() {
        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="left">
                    <img src="https://d86b4hfhts8hr.cloudfront.net/Tetris/Illus/Illu.png" />
                </div>

                <div className="right">
                    <div className="header">Quizzie Easy</div>
                    <div className="sub-header">Kids Learning while Playing</div>
                    {page}
